...
struct ImagezoomViewer: View {
    ...
    public init(image: Binding<String>, viewerShown: Binding<Bool>, aspectRatio: Binding<CGFloat>? = nil, caption: Text? = nil, closeButtonTopRight: Bool? = false) {
        _image_url = image
